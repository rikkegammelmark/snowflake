...
* @returns {Document}
*/
export function create_document(source, seed, depth) {
    var ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.create_document(ptr0, len0, seed, depth);
...
* @returns {string}
*/
export function compile_and_run(doc) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(doc, Document);
        var ptr0 = doc.ptr;
        doc.ptr = 0;
        wasm.compile_and_run(retptr, ptr0);
...
/**
*/
export function snow_initialize() {
    wasm.snow_initialize();
}
